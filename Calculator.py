...
backspacebutton = Button(win, text='⌫', width=4,font = 'Helvetica 8'  ,command=lambda: clear1(),fg='black',bg='light green')
...
# clear buttons
clearbutton = Button(win, text='C', width=4, command=lambda: clearall(),fg='black',bg='light green').grid(row=3, column=0, stick='e')
cebutton = Button(win, text='CE', width=4, command=lambda: clearall(),fg='black',bg='light green').grid(row=3, column=1, stick='e')
